...
(13, 'Aldous Huxley', 'Szép új világ', '/uploads/brave.jpg', 'A jövő utópisztikus társadalma, amelyben az emberek génjeit és életét előre meghatározzák.', 0),
(14, 'F. Scott Fitzgerald', 'A nagy Gatsby', '/uploads/gatsby.jpg', 'A 1920-as évek amerikai társadalmát bemutató regény a szerelemről, gazdagságról és árulásról.', 5),
(15, 'Harper Lee', 'Ne bántsátok a feketerigót!', '/uploads/mockingbird.jpg', 'Egy amerikai déli kisváros története, a rasszizmus és az igazságosság kérdéseivel.', 10),
(16, 'Stanley Kubrick', '2001: Űrodüsszeia', '/uploads/2001.jpg', 'Stanley Kubrick 1968-as sci-fi filmje, amely az emberiség és a mesterséges intelligencia kapcsolatát vizsgálja.', 2),
(17, 'Peter Jackson', 'A Gyűrűk Ura: A Gyűrű Szövetsége', '/uploads/lotr1.jpg', 'A fantasy trilógia első része, ahol a hobbitok, varázslók és harcosok együtt indulnak megmenteni Középföldét.', 0),
(18, 'Peter Jackson', 'A Gyűrűk Ura: A két torony', '/uploads/lotr2.jpg', 'A második részben folytatódik a gyűrű pusztító erejének megállítása a harcosok és hobbitok által.', 4),
(19, 'Peter Jackson', 'A Gyűrűk Ura: A király visszatér', '/uploads/lotr3.jpg', 'A trilógia befejező része, ahol a végső harc a Sötét Úr ellen lezárul.', 7),
(20, 'Suzanne Collins', 'Az éhezők viadala', '/uploads/hunger1.jpg', 'Katniss Everdeen életét követhetjük, aki túlél a diktatórikus Panem országában a halálos játékokban.', 5),
(21, 'Suzanne Collins', 'Az éhezők viadala: Futótűz', '/uploads/hunger2.jpg', 'Katniss a halálos viadal után a felkelés szimbólumává válik, és folytatódik a harc a diktatúra ellen.', 14),
(22, 'Suzanne Collins', 'Az éhezők viadala: A kiválasztott', '/uploads/hunger3.jpg', 'A sorozat befejező része, amelyben Katniss és társai végső összecsapásra készülnek a Kapitólium ellen.', 5),
(23, 'J. R. R. Tolkien', 'A Hobbit', '/uploads/hobbit.jpg', 'Bilbó kalandjai a sárkány Smaug és a kincsek világában, amely a Gyűrűk Ura előzménye.', 12),
(24, 'Dan Brown', 'Da Vinci-kód', '/uploads/davinci.jpg', 'Robert Langdon professzor titkok és rejtélyek után kutatva a Louvre-ban és egész Európában.', 0),
(25, 'Dan Brown', 'Az elveszett jel', '/uploads/lostsymbol.jpg', 'Langdon professzor Washington D.C.-ben folytatja a titkok feltárását, szimbólumok és összeesküvések közepette.', 3),
(26, 'Jules Verne', '20 000 mérföld a tenger alatt', '/uploads/20000.jpg', 'Kapcsolódó sci-fi kaland a tengerek mélyén, a Nautilus kapitányával és legénységével.', 8),
(27, 'Mary Shelley', 'Frankenstein', '/uploads/frankenstein.jpg', 'A klasszikus horrorregény a tudomány határairól és az ember teremtő erejéről.', 9),
(28, 'Bram Stoker', 'Drakula', '/uploads/dracula.jpg', 'A híres vámpír történet, amely a misztikum és a horror alapműve.', 0),
(29, 'H. G. Wells', 'Az időgép', '/uploads/time.jpg', 'Egy tudós időutazásai a jövőben, és az emberiség sorsa a távoli világokban.', 10),
...
(31, 'Victor Hugo', 'A párizsi Notre-Dame', '/uploads/notredame.jpg', 'Quasimodo és Esmeralda tragikus története a középkori Párizsban.', 11),
(32, 'Alexandre Dumas', 'A három testőr', '/uploads/3musketiers.jpg', 'A kalandregény D’Artagnan és három testőre küzdelmei a francia királyi udvarban.', 0),
(33, 'Homer', 'Iliász', '/uploads/iliad.jpg', 'Az ókori görög eposz a trójai háború eseményeiről, hőseiről és istenek beavatkozásairól.', 4),
(34, 'Homer', 'Odüsszeia', '/uploads/odyssey.jpg', 'Odüsszeusz hazatérési útja és kalandjai a mitológiai világban.', 9);
-- --------------------------------------------------------
