    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, connection.query("select * from reviews")];
                case 3:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, connection.query("select * from reviews where flagged = 1")];
                case 3:
                    _a = __read.apply(void 0, [_b.sent(), 1]), results = _a[0];
                    response.status(200).send(results);
                    return [3 /*break*/, 5];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, connection.query("delete from reviews where r_id = ?", [id])];
                case 3:
                    _a = __read.apply(void 0, [_b.sent(), 1]), results = _a[0];
...
function insertReview(request, response) {
    return __awaiter(this, void 0, void 0, function () {
        var review, connection, _a, results, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!request.body) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, connection.query("insert into reviews values (null, ?, ?, ?, ?, ?)", [review.i_id, review.u_id, review.flagged, review.stars, review.comment])];
                case 3:
                    _a = __read.apply(void 0, [_b.sent(), 1]), results = _a[0];
                    if (results.affectedRows > 0) {
